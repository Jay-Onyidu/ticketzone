...
var expiration_complete_publisher_1 = require("../events/publishers/expiration-complete-publisher");
var nats_wrapper_1 = require("../nats-wrapper");
var expirationQueue = new bull_1.default('order:expiration', {
    redis: {
        host: process.env.REDIS_HOST,
    },
});
exports.expirationQueue = expirationQueue;
expirationQueue.process(function (job) { return __awaiter(void 0, void 0, void 0, function () {
