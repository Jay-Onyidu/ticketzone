...
it('returns a 204 with valid imput', function () { return __awaiter(void 0, void 0, void 0, function () {
    var userId, order, chargeOptions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = mongoose_1.default.Types.ObjectId().toHexString();
            ...
            case 2:
                _a.sent();
                expect(201);
                chargeOptions = stripe_1.stripe.charges.create.mock.calls[0][0];
