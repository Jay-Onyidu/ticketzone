...
var ticket_created_publisher_1 = require("../events/publishers/ticket-created-publisher");
...
router.post('/api/tickets', common_1.requireAuth, [
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.sent();
                return [4 /*yield*/, new ticket_created_publisher_1.TicketCreatedPublisher(nats_wrapper_1.natsWrapper.client).publish({
                        id: ticket.id,
                        title: ticket.title,
                        price: ticket.price,
