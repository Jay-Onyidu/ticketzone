...
var ticket_updated_publisher_1 = require("../events/publishers/ticket-updated-publisher");
...
router.put('/api/tickets/:id', common_1.requireAuth, [
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, new ticket_updated_publisher_1.TicketUpdatedPublisher(nats_wrapper_1.natsWrapper.client).publish({
                        id: ticket.id,
                        title: ticket.title,
                        price: ticket.price,
