...
var order_cancelled_publisher_1 = require("../events/publishers/order-cancelled-publisher");
var nats_wrapper_1 = require("../nats-wrapper");
var router = express_1.default.Router();
exports.deleteOrderRouter = router;
router.delete('/api/orders/:orderId', common_1.requireAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orderId = req.params.orderId;
                return [4 /*yield*/, order_1.Order.findById(orderId).populate('ticket')];
            case 1:
                order = _a.sent();
                if (!order) {
